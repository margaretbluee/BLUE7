...
FB_Clients fb_clients = fbclientsList.get(position);
        ...
        holder.fbagecTxt.setText(String.valueOf(fb_clients.getFb_client_age()));
        holder.fbgendercTxt.setText(String.valueOf(fb_clients.getFb_client_gender()));
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder  {
        public  TextView fbidcTxt,fbnamecTxt, fbagecTxt, fbgendercTxt, fbratcTxt;
        ...
        public  MyViewHolder(@NonNull View itemView) {
            ...
            fbagecTxt = itemView.findViewById(R.id.row_clagefb);
            fbgendercTxt = itemView.findViewById(R.id.row_clgenderfb);
