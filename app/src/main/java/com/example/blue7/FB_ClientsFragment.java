...
public class FB_ClientsFragment extends Fragment  implements AdapterListenerFBClients {
    EditText fbcid, fbcname, fbcage, fbcgender, fbcrating;
    Button insert;
...
List<FB_Clients> fb_clients = new ArrayList<>();
        ...
        fbcage = view.findViewById(R.id.fbcage);
        fbcgender = view.findViewById(R.id.fbcgender);
    ...
    fbcrating.setText(String.valueOf(rating) );
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int Var_clientage = 0;
                try {
                    Var_clientage = Integer.parseInt(fbcage.getText().toString());
                } catch (NumberFormatException ex) {
                    System.out.println("Could not parse " + ex);
                }
                String Var_clientgender = fbcgender.getText().toString();
                ...
                try {
                    ...
                    fb_clients.setFb_client_age(Var_clientage);
                    fb_clients.setFb_client_gender(Var_clientgender);
        ...
        collectionReference.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                for(QueryDocumentSnapshot documentSnapshot: queryDocumentSnapshots){
                    ...
                    Integer cage = fb_clients1.getFb_client_age();
                   String gender =fb_clients1.getFb_client_gender();
