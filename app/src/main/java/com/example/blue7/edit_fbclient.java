...
TextView IdEtnfbc;
    EditText   NameEtnfbc,AgeEtnfbc ,GenderEtnfbc ,RatEtnfbc   ;
...
int cid;///
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IdEtnfbc=findViewById(R.id.companiesIdc);
        NameEtnfbc=findViewById(R.id.clientsNamedfb);
      AgeEtnfbc=findViewById(R.id.clientsAgedfb);
        GenderEtnfbc=findViewById(R.id.clientsGenderfb);
        RatEtnfbc=findViewById(R.id.clientsRatfb);
         ...
         ImageView close_itemsfbc = findViewById(R.id.closeAlertdc);
       ...
       AgeEtnfbc.setText(String.valueOf(fb_clients.getFb_client_age()));
      GenderEtnfbc.setText( String.valueOf(fb_clients.getFb_client_gender()));
...
///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        buttondialogfbc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    fb_clients.setFb_client_age(Integer.parseInt(AgeEtnfbc.getText().toString()));
                    fb_clients.setFb_client_rating(Float.parseFloat(RatEtnfbc.getText().toString()));
                    fb_clients.setFb_client_gender(GenderEtnfbc.getText().toString());
