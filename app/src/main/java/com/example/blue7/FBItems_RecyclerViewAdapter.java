...
class FBItems_RecyclerViewAdapter extends RecyclerView.Adapter<FBItems_RecyclerViewAdapter.MyViewHolder>{
     private List<FB_Items> fbitemsList;
    private Context context;
    private AdapterListenerFBItems fbadapterListener;
...
int count = MainActivity.myAppDatabaseEshop.myDaoEshop().getItemsCount_withName(fbitems.getFb_item_name());
